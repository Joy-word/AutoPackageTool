...
namespace AutoPackage {
    ...
    public sealed class AutoPackageCommandPackage : AsyncPackage {
        /// <summary>
        /// AutoPackageCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "952813f4-c975-446a-bc66-a3b137da4dfc";

        /// <summary>
        /// Initializes a new instance of the <see cref="AutoPackageCommandPackage"/> class.
        /// </summary>
